...
const TOAST_MESSAGES = {
  ...
  deleteInvoice: { success: '發票已刪除', error: '刪除發票失敗' },
  deleteApplication: { success: '申請單已刪除', error: '刪除申請單失敗' },
  deleteAttachment: { success: '附件已刪除', error: '刪除附件失敗' },
  ...
  deletePayee: { success: '所得人已刪除', error: '刪除所得人失敗' },
}
